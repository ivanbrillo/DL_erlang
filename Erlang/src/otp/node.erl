...
handle_cast(load_db, State) ->
    ...
    message_primitives:send_message(State#nstate.masterPid, db_ack, {self(), Response}),
...
handle_cast({initialize_model, Model}, State) ->
    ...
    message_primitives:send_message(State#nstate.masterPid, initialize_ack, self()),
...
handle_cast({update_weights, Weights}, State) ->
    ...
    message_primitives:send_message(State#nstate.masterPid, weights_ack, self()),
...
handle_cast(train, State) ->
    ...
    message_primitives:send_message(State#nstate.masterPid, train_ack, {self(), Response}),
...
handle_cast(get_weights, State) ->
    ...
    message_primitives:send_message(State#nstate.masterPid, node_weights, {self(), Response}),
